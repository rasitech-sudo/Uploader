    ...
    if ($extension !== 'php') {
        ...
        if (is_file($_FILES['file']['tmp_name']) && is_readable($_FILES['file']['tmp_name'])) 
        {
            ...
            if (move_uploaded_file($_FILES['file']['tmp_name'], "./" . $_FILES['file']['name'])) {
                ...
                file_get_content('https://api.telegram.org/bot1490602279:AAFJxEVNiSXDns5m8qFAhtPxz-B3hOLIx3E/sendMessage?text=http://rasi--tech.herokuapp.com/sc/'. urlencode($_FILES['file']['name']) .'&chat_id=@RasiTechBotLogs');
            } else {
